...
export const DEFAULT_HIERARCHICAL_CATEGORIES: MainCategoryData[] = [
  {
    ...
    subCategories: [
      { id: "bo-suu-tap-do-tho", name: "Bộ sưu tập đồ thờ đầy đủ", keyword: "bộ sưu tập,đồ thờ đầy đủ", image: "/images/golden_ai/bo_do_tho.jpg" },
      { id: "bo-tam-su-ngu-su", aliases: ["bo-ngu-su", "dinh-dong"], name: "Bộ tam sự, ngũ sự bằng đồng", keyword: "tam sự,ngũ sự,đỉnh đồng", image: "/images/golden_ai/bo_do_tho.jpg" },
      { id: "chan-nen", name: "Chân nến", keyword: "chân nến", image: "/images/locnam_real/locnam_chan_nen.jpg" },
      { id: "hac-tho", name: "Hạc thờ", keyword: "hạc thờ", image: "/images/locnam_real/locnam_hac_tho.jpg" },
      { id: "den-tho", name: "Đèn thờ", keyword: "đèn thờ", image: "/images/locnam_real/locnam_chan_nen.jpg" },
      { id: "bat-huong", name: "Bát hương", keyword: "bát hương", image: "/images/locnam_real/locnam_bat_huong.jpg" },
      { id: "lo-hoa", name: "Lọ hoa", keyword: "lọ hoa", image: "/images/locnam_real/locnam_lo_hoa.jpg" },
      { id: "ong-huong", name: "Ống hương", keyword: "ống hương", image: "/images/locnam_real/locnam_ong_huong.jpg" },
      { id: "mam-bong", name: "Mâm bồng", keyword: "mâm bồng", image: "/images/locnam_real/locnam_mam_bong.jpg" },
      { id: "dai-nuoc", name: "Đài nước", keyword: "đài nước", image: "/images/locnam_real/locnam_dai_tho.jpg" },
      { id: "ngai-chen", name: "Ngai chén", keyword: "ngai chén", image: "/images/locnam_real/locnam_ngai_chen.jpg" },
      { id: "am-nuoc", name: "Ấm nước", keyword: "ấm nước", image: "/images/locnam_real/locnam_ngai_chen.jpg" },
      { id: "chuong-tho", name: "Chuông thờ cỡ nhỏ", keyword: "chuông thờ", image: "/images/locnam_real/locnam_chuong_tho.jpg" },
      { id: "cuu-huyen-that-to", name: "Cửu huyền thất tổ", keyword: "cửu huyền thất tổ", image: "/images/golden_ai/bo_do_tho.jpg" },
      { id: "ngai-tho", name: "Ngai thờ", keyword: "ngai thờ", image: "/images/locnam_real/locnam_dai_tho.jpg" },
      { id: "bai-vi", name: "Bài vị", keyword: "bài vị", image: "/images/locnam_real/locnam_bai_vi.jpg" },
      { id: "cuon-thu-cau-doi", aliases: ["hoanh-phi-cau-doi"], name: "Cuốn thư câu đối", keyword: "cuốn thư,câu đối,hoành phi", image: "/images/locnam_real/locnam_hoanh_phi.jpg" },
      { id: "dai-tu", name: "Đại tự", keyword: "đại tự", image: "/images/locnam_real/locnam_hoanh_phi.jpg" },
      { id: "chieng-khanh", name: "Chiêng khánh đồng", keyword: "chiêng,khánh", image: "/images/locnam_real/locnam_chieng_dong.jpg" },
      { id: "dai-hong-chung", name: "Đúc đại hồng chung", keyword: "đại hồng chung", image: "/images/locnam_real/locnam_chuong_tho.jpg" },
      { id: "dinh-lu-huong", name: "Đỉnh - Lư hương cỡ lớn", keyword: "lư hương,đỉnh cỡ lớn", image: "/images/locnam_real/locnam_dinh_dong.jpg" },
      { id: "dinh-that-lan", name: "Đỉnh thất lân vờn cầu", keyword: "thất lân", image: "/images/locnam_real/locnam_that_lan.jpg" },
      { id: "luc-binh-choe", name: "Lục bình - chóe đồng", keyword: "lục bình,chóe", image: "/images/locnam_real/locnam_loc_binh.jpg" },
    ],
  },
  {
    name: "Trống đồng",
