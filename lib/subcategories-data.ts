  ...
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        ...
        children: [
          { id: "tuong-tran-hung-dao", name: "Tượng đồng Trần Hưng Đạo", keyword: "trần hưng đạo", image: "/images/locnam_real/locnam_tran_hung_dao.jpg?v=3" },
          { id: "tuong-bac-ho", name: "Tượng Bác Hồ", keyword: "bác hồ", image: "/images/locnam_real/locnam_bac_ho.jpg?v=3" },
          { id: "tuong-vo-nguyen-giap", name: "Tượng Bác Võ Nguyên Giáp", keyword: "võ nguyên giáp,bác giáp", image: "/images/locnam_real/locnam_bac_giap.jpg?v=3" },
          { id: "tuong-gia-cat-luong", aliases: ["tuong-khong-minh"], name: "Tượng Gia Cát Lượng", keyword: "khổng minh,gia cát lượng", image: "/images/locnam_real/locnam_khong_minh.jpg?v=3" },
