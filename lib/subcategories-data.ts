...
export const DEFAULT_HIERARCHICAL_CATEGORIES: MainCategoryData[] = [
  {
    ...
    subCategories: [
      ...
      { id: "chuong-tho", aliases: ["chuong-tho-nho-dai-hong-chung"], name: "Chuông thờ nhỏ - Đại hồng chung", keyword: "chuông thờ,chuông đồng,đại hồng chung,chuông nhỏ", image: "/images/do-tho-cung/chuong-tho.jpg" },
      ...
      { id: "chieng-khanh", aliases: ["chieng-khanh-chuong-bat"], name: "Chiêng - Khánh - Chuông bát", keyword: "chiêng,khánh,chiêng đồng,khánh đồng,chuông bát,chieng dong,khanh dong,chuong bat", image: "/images/do-tho-cung/chieng-khanh.jpg" },
